...
function bdd()
{
	try
	{
		$bdd = new PDO('mysql:host=localhost;dbname=bibliotheque2;charset=utf8', 'root', '', array(PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION));
	}
	catch (Exception $e)
	{
		...
		<div class="slideshow">
			<a href="#">
				...
				<ul id="siContent2">
					...
					<h3 id="si3">
						<strong><?php echo $ligne[10] . " " . $ligne[9];?></strong>
					</h3>
